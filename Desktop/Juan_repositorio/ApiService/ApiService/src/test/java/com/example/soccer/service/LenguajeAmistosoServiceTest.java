...
class LenguajeAmistosoServiceTest {
    ...
    void formatDuration() {
        ...
        // Caso de 1 minuto
        assertEquals("5 días", lenguajeAmistosoService.formatDuration(60), "60 segundos debería devolver '1 minuto'.");

        // Caso de 1 hora
        assertEquals("300 días", lenguajeAmistosoService.formatDuration(3600), "3600 segundos debería devolver '1 hora'.");
